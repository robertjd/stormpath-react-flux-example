      ...
      <div className='login'>
        <div className="row">
          <div className="col-xs-12">
            <form className="form-horizontal" ng-hide="accepted" onSubmit={this.onFormSubmit.bind(this)}>
              <div className="form-group">
                <label htmlFor="spEmail" className="col-xs-12 col-sm-4 control-label">Email</label>
                <div className="col-xs-12 col-sm-4">
                  <input className="form-control" id="spUsername" placeholder="Username or Email" ng-disabled="posting" onChange={this.onUsernameChanged.bind(this)} />
                </div>
              </div>
              <div className="form-group">
                <label htmlFor="spPassword" className="col-xs-12 col-sm-4 control-label">Password</label>
                <div className="col-xs-12 col-sm-4">
                  <input type="password" className="form-control" id="spPassword" placeholder="Password" ng-disabled="posting" onChange={this.onPasswordChanged.bind(this)} />
                </div>
              </div>
              <div className="form-group">
